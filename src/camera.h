...
private:
  ...
  Vector3 view_dir_; /*!< Opačný směr pohledu. Vypočítává se na základě zoom_, alt_ a azim_. */
  ...
  Vector3 axis_x_; /*!< Bázový vektor souřadného systému reprezentující x-ovou osu. */
  Vector3 axis_y_; /*!< Bázový vektor souřadného systému reprezentující y-ovou osu. */
  Vector3 axis_z_; /*!< Bázový vektor souřadného systému reprezentující z-ovou osu. */
